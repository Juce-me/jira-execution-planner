...
| ENG Board/Catch Up filter facet ticks, chip clears, and +n more | `frontend/src/eng/EngFilterBar.jsx`, `frontend/src/eng/EngBoardView.jsx`, `frontend/src/eng/EngView.jsx` | These controls only re-slice already-loaded data. Keeping them untracked preserves comparable semantics across Board and Catch Up and sends no facet values, group names, issue keys, or Jira data. | 2026-08-08 |
