...
- For screen-scoped onboarding, target Board at one real collapsed Epic workflow rail and target Statistics at its real view selector; never spotlight the full rendered panels.
