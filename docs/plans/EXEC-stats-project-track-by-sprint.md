...
- **MRT020 rebuild of the filter bar's exclusion controls.** The first exclusions implementation reinvented bespoke controls instead of reusing existing `.stats-control-group`/checkbox patterns; see `docs/postmortem/MRT020-project-track-filter-bar-bespoke-controls.md` (commits `526d3e6`, `ea08194`, `93541f4`) for the postmortem and fix. The exclusion checkboxes now reuse the established inline-checkbox pattern.
