...
def register_blueprints(flask_app):
    ...
    from backend.routes.performance_routes import bp as performance_bp
    ...
    from backend.routes.eng_board_routes import bp as eng_board_bp
    ...
    flask_app.register_blueprint(eng_board_bp)
