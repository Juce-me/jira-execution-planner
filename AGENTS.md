...
- `frontend/dist/` is committed frontend output, not protected. CSS lives in `frontend/dist/dashboard.css`; update it directly when styling changes require it, and rebuild/update bundled JS assets when JSX changes require it.
