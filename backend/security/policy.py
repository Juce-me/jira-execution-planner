...
ENDPOINT_POLICIES = (
    ...
    EndpointPolicy("eng-api-issue-description", "/api/issues/description", PUBLIC_METHODS, "authenticated_read"),
    ...
    EndpointPolicy("jira-issue-editable-fields", "/api/issues/<issue_key>/editable-fields", PUBLIC_METHODS, "authenticated_read", "dynamic"),
    EndpointPolicy("jira-issue-field-user-options", "/api/issues/<issue_key>/user-options", frozenset({"POST"}), "user_write", "dynamic"),
    EndpointPolicy("jira-issue-field-write", "/api/issues/<issue_key>/field", frozenset({"POST"}), "user_write", "dynamic"),
    ...
    EndpointPolicy("board-config-statuses-read", "/api/board-config/statuses", PUBLIC_METHODS, "authenticated_read"),
    ...
    EndpointPolicy("delivery-owner-config-read", "/api/delivery-owner-field/config", PUBLIC_METHODS, "authenticated_read"),
    EndpointPolicy("delivery-owner-config-write", "/api/delivery-owner-field/config", frozenset({"POST"}), "shared_admin_write"),
    ...
    EndpointPolicy("eng-story-readiness", "/api/eng/story-readiness", PUBLIC_METHODS, "authenticated_read"),
