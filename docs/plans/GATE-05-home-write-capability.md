...
| Last result | FAIL insufficient_home_write_probe_input (probe not re-run: all required operator inputs are unavailable; user-onboarding-tour execution adds no Home write path) |
